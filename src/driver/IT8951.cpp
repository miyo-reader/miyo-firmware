...
IT8951::IT8951(hal::interface::SPI & spi,
...
IT8951::Error IT8951::read(uint16_t & data)
{
...
IT8951::Error IT8951::write(uint16_t const data)
{
  CHECK_RETURN_VAL(waitForHostReady());
  select();
...
IT8951::Error IT8951::command(Command const cmd)
{
  CHECK_RETURN_VAL(waitForHostReady());
  select();
...
IT8951::Error IT8951::waitForHostReady()
{
  while (!isHostReady()) { /* TODO: Introduce timeout. */ }
  return Error::None;
}

IT8951::Error IT8951::spi_send(Preamble const preamble)
{
...
IT8951::Error IT8951::spi_send(uint16_t const data)
{
...
IT8951::Error IT8951::spi_recv(uint16_t & data)
{
